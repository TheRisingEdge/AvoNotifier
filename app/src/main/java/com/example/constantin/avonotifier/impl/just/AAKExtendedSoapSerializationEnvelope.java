...
public class AAKExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("portalquery.just.ro^^Dosar",AAKDosar.class);
        classNames.put("portalquery.just.ro^^DosarParte",AAKDosarParte.class);
        classNames.put("portalquery.just.ro^^DosarSedinta",AAKDosarSedinta.class);
        classNames.put("portalquery.just.ro^^DosarCaleAtac",AAKDosarCaleAtac.class);
        classNames.put("portalquery.just.ro^^ArrayOfDosar",AAKArrayOfDosar.class);
        classNames.put("portalquery.just.ro^^ArrayOfDosarParte",AAKArrayOfDosarParte.class);
        classNames.put("portalquery.just.ro^^ArrayOfDosarSedinta",AAKArrayOfDosarSedinta.class);
        classNames.put("portalquery.just.ro^^ArrayOfDosarCaleAtac",AAKArrayOfDosarCaleAtac.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public AAKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AAKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AAKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AAKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl,boolean typeFromClass)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,AAKExtendedSoapSerializationEnvelope.class);
